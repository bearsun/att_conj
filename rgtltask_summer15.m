function rgtltask_summer15(debug)

% Updated 6/10/15 by Liwei, this function is for the control group, in
% which they will do 1st and the last session the same as the exp group
% while the middle 8 sessions with only central task. So I need to change
% the rewards/responses here.
